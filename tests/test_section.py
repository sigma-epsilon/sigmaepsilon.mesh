...
class TestSection(unittest.TestCase):
    ...
    def test_TFI(self):
        LineSection('TFI', d=588, b=191, t_f=27.2, t_w=15.2, r_r=17.8, r_f=8.9, alpha=8, n_r=16)
        
    def test_PFC(self):
        LineSection('PFC', d=250, b=90, t_f=15, t_w=8, r=12, n_r=8)
        
    def test_TFC(self):
        LineSection('TFC', d=10, b=3.5, t_f=0.575, t_w=0.475, r_r=0.575, r_f=0.4, alpha=8, n_r=16)
